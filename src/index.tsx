        ...
        <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <div class="flex flex-col items-center justify-center mb-4">
                    <img src="/static/logos/corefirst-logo-new.png" alt="Core First" class="h-8 mb-4">
  ...
  return c.html(`
    ...
    <body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <div class="flex flex-col items-center justify-center mb-4">
                    <img src="/static/logos/corefirst-logo-new.png" alt="Core First" class="h-10 mb-4">
            ...
            <aside id="sidebar" class="flex-shrink-0 w-64 bg-white transition-all duration-300 ease-in-out shadow-xl border-r border-gray-200">
                <div class="flex flex-col h-full">
                    ...
                    <div class="flex items-center justify-center h-16 bg-white border-b border-gray-200 px-4">
                        <img src="/static/logos/corefirst-logo-new.png" alt="Core First" class="h-6" id="sidebar-logo">
                    </div>
            ...
            <div class="text-center max-w-2xl mx-auto px-4">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-center mb-6">
                        <img src="/static/logos/corefirst-logo-new.png" alt="Core First" class="h-12">
                    </div>
